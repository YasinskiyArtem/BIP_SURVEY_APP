...
ALLOWED_HOSTS = ['survey-form.ru', 'www.survey-form.ru', 'localhost', '127.0.0.1', '195.133.201.21']

CSRF_TRUSTED_ORIGINS=["https://survey-form.ru"]
...
STATIC_URL = '/static/'
#STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'static')  # Важно!
